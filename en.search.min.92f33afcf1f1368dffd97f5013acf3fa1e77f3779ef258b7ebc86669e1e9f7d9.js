...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reachy-docs/flexsearch.min.js');loadScript('/reachy-docs/en.search-data.min.e881bf19e9130dc68c65aae6b8ff410dc775f0b8fd8c9808a64c3b44266a4b7f.js',function(){input.required=false;search();});}
