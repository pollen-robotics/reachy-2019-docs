...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reachy-docs/flexsearch.min.js');loadScript('/reachy-docs/en.search-data.min.447134f85a9f237a560b76969bf5efc9afabd0a1f3266a96267331f717355a94.js',function(){input.required=false;search();});}
