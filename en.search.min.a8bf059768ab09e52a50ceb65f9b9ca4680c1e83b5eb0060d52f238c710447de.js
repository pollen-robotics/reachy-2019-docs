...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reachy-docs/flexsearch.min.js');loadScript('/reachy-docs/en.search-data.min.001ebb5291b684d842fc0d226ac71eaeb159e78477e839689ccf0affe3eacce1.js',function(){input.required=false;search();});}
