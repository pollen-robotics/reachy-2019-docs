...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reachy-docs/flexsearch.min.js');loadScript('/reachy-docs/en.search-data.min.244405d6c739df457e54defdaa5f787c9e7e7c8186660ad120c14ff8faed63d4.js',function(){input.required=false;search();});}
