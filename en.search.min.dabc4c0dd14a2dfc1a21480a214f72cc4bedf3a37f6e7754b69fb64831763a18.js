...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reachy-docs/flexsearch.min.js');loadScript('/reachy-docs/en.search-data.min.b3565e0ac9a2577f5fa7a7d1c66da385372d58572fe1b92972476008e636d958.js',function(){input.required=false;search();});}
