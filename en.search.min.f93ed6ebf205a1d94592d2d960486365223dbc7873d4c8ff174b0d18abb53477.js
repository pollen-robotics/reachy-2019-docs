...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reachy-docs/flexsearch.min.js');loadScript('/reachy-docs/en.search-data.min.dfa8d5f662ebbabfda9971db3038e6a92af93b045fd83dc1a544cfffeea48c7b.js',function(){input.required=false;search();});}
