...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reachy-docs/flexsearch.min.js');loadScript('/reachy-docs/en.search-data.min.538f8bd23ee63ab1a924a490c33242b1cf96fbb429544f349ea9d99f591be9b6.js',function(){input.required=false;search();});}
