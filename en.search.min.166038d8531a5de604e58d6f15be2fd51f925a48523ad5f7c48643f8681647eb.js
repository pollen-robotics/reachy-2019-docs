...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reachy-docs/flexsearch.min.js');loadScript('/reachy-docs/en.search-data.min.601b5619119df14aa78d3c9ab61357e65f41798358242b34085635631ac1071c.js',function(){input.required=false;search();});}
