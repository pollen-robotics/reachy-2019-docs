...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reachy-docs/flexsearch.min.js');loadScript('/reachy-docs/en.search-data.min.da85a7ac50ed5cf8765cf4789b0c63bb1197d086e212e478df88225432b04dbe.js',function(){input.required=false;search();});}
