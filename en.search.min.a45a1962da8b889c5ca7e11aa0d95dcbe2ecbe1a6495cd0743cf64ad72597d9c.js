...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reachy-docs/flexsearch.min.js');loadScript('/reachy-docs/en.search-data.min.3ce202525bd5db19953495528566f6a9717927c7887430a7c19f5cfa4a77248e.js',function(){input.required=false;search();});}
