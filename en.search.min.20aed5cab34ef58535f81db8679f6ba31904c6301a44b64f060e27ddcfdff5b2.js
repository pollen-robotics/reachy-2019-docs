...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reachy-docs/flexsearch.min.js');loadScript('/reachy-docs/en.search-data.min.7a84828f9ff48c62e5a340501f3be8052873f1b2573c475a8b3b8df92ffadb96.js',function(){input.required=false;search();});}
