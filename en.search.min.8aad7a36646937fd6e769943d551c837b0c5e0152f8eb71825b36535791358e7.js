...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reachy-docs/flexsearch.min.js');loadScript('/reachy-docs/en.search-data.min.85af6f0208388ddfa1ad41c9eb12853832f890a0f984bf65ab767c45765a4045.js',function(){input.required=false;search();});}
