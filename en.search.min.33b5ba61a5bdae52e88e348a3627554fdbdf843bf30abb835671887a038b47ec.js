...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reachy-docs/flexsearch.min.js');loadScript('/reachy-docs/en.search-data.min.e034387cbf493e4701102a30a609da155be2799dd8906e2fa9796d7fde97b42d.js',function(){input.required=false;search();});}
