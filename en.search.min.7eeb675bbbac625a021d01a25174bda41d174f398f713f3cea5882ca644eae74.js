...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reachy-docs/flexsearch.min.js');loadScript('/reachy-docs/en.search-data.min.fb57aae09421daf61ba3be7b09824abddb8e524b5de044013e0628309220e33c.js',function(){input.required=false;search();});}
