...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reachy-docs/flexsearch.min.js');loadScript('/reachy-docs/en.search-data.min.f0620523ba0699eac21928e9bf034693e62c20d95192eefc1655099fcfd37c47.js',function(){input.required=false;search();});}
